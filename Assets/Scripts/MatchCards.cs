...
public class MatchCards : MonoBehaviour
{
    ...
    private void ChangeSprite()
    {
        ...
        if (flipped)
            img.sprite = CardController.Instance.GetSprite(spriteID);
        else
            img.sprite = CardController.Instance.CardBack();
    }
    ...
    public void CardBtn()
    {
        ...
        if (!CardController.Instance.canClick()) return;
        Flip();
    ...
    private IEnumerator SelectionEvent()
    {
        ...
        CardController.Instance.cardClicked(spriteID, id);
    }
}
